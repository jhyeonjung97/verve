...
Ec_metal = pd.read_csv('energy_sub.tsv', delimiter='\t', index_col=0)

Ec_oxygen = 5.1614  # eV
Ec_oxide = pd.DataFrame(index=Ec_metal.index)
Ec_oxide['energy'] = Ec_metal['sublimation'] + Ec_oxygen - Ef_oxide['energy']
