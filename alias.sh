...
alias hi='sh ~/bin/verve/gits.sh orange shoulder verve tools Resume HybridPB
...
alias suncat='ssh -X -Y jiuy97@suncat'
...
alias bye='sh ~/bin/verve/gits.sh orange shoulder verve tools Resume HybridPB'
