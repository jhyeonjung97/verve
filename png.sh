...
if [[ ${here} == 'slac' ]]; then
    ...
    python ~/bin/verve/lr.py -o 5 --C concat_coord.tsv -i ICOHP MadelungL IE1 IE2 IE3 --Y concat_norm_formation.tsv --X concat_ICOHP.tsv concat_norm_MadelungL.tsv concat_IE1.tsv concat_IE2.tsv concat_IE3.tsv > regression7.log 
