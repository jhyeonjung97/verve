...
python ~/bin/verve/lr.py -i ICOBI MadelungL volume bond chg CFSE IE1 redoxP IE3 group number density --Y concat_norm_formation.tsv --X concat_ICOBI.tsv concat_norm_MadelungL.tsv concat_norm_volume.tsv concat_bond.tsv concat_chg.tsv concat_cfse.tsv concat_IE1.tsv concat_redoxP.tsv concat_IE3.tsv concat_group.tsv concat_number.tsv concat_density.tsv
