...
if [[ ${here} == 'slac' ]]; then
    ...
    for dir in */; do
            ...
            python ~/bin/verve/tsv.py -l 3d_afm 3d_fm 3d 4d 5d -x "Metal (MO)" -y "Gross population (Loewdin)" -o magnetization */energy_magnetization.tsv
    ...
    python ~/bin/verve/tsv.py -r 3d -x "Metal (MO)" -y "Formation energy (eV/MO)" -o norm_formation_3d_afm */1_afm/energy_norm_formation.tsv
    python ~/bin/verve/tsv.py -r 3d -x "Metal (MO)" -y "Formation energy (eV/MO)" -o norm_formation_3d_fm */2_fm/energy_norm_formation.tsv
    python ~/bin/verve/tsv.py -r 3d -x "Metal (MO)" -y "Formation energy (eV/MO)" -o norm_formation_3d */3d/energy_norm_formation.tsv
    python ~/bin/verve/tsv.py -r 4d -x "Metal (MO)" -y "Formation energy (eV/MO)" -o norm_formation_4d */4d/energy_norm_formation.tsv
    python ~/bin/verve/tsv.py -r 5d -x "Metal (MO)" -y "Formation energy (eV/MO)" -o norm_formation_5d */5d/energy_norm_formation.tsv
    
    python ~/bin/verve/tsv.py -r 3d -x "Metal (MO)" -y "MadelungL energy (eV/MO)" -o norm_MadelungL_3d_afm */1_afm/energy_norm_Madelung_Loewdin.tsv
    python ~/bin/verve/tsv.py -r 3d -x "Metal (MO)" -y "MadelungL energy (eV/MO)" -o norm_MadelungL_3d_fm */2_fm/energy_norm_Madelung_Loewdin.tsv
    python ~/bin/verve/tsv.py -r 3d -x "Metal (MO)" -y "MadelungL energy (eV/MO)" -o norm_MadelungL_3d */3d/energy_norm_Madelung_Loewdin.tsv
    python ~/bin/verve/tsv.py -r 4d -x "Metal (MO)" -y "MadelungL energy (eV/MO)" -o norm_MadelungL_4d */4d/energy_norm_Madelung_Loewdin.tsv
    python ~/bin/verve/tsv.py -r 5d -x "Metal (MO)" -y "MadelungL energy (eV/MO)" -o norm_MadelungL_5d */5d/energy_norm_Madelung_Loewdin.tsv
fi