...
def main():
    ...
    plotting_adv(df=df_chg, df_ref=df_ref, pattern='charge', xlabel='Bader charge (e-)', filename=chg_filename,
                 figsize1=(8, 6), bins1=np.arange(1.0, 2.0, 0.01), width1=0.009, xticks1=np.arange(1.0, 2.1, 0.1), xmin1=0.9, xmax1=2.1, 
                 figsize2=(12, 6), bins2=np.arange(1.0, 2.1, 0.02), width2=0.02, xticks2=np.arange(1.0, 2.1, 0.1), xmin2=0.9, xmax2=2.1)
