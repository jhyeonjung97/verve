...
alias cdw='cd /sdf/data/suncat/suncatlustre/hailey/'
alias cdp='cd /sdf/data/suncat/suncatlustre/'
...
squeue -o "%.10i %.9P %.16j %.6u %.10T %.8M %.10l %.6D %.15R" --me --sort=i | grep "30:00" | grep regular'
